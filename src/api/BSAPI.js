...
export default {
  ...
  addBlacklist(blacklist) {
    return axios.post(CONF.ADD_BLACKLIST, blacklist);
  },
  updateBlacklist({ bid, blType }) {
    console.log("bid, blType :", bid, blType);
    return axios.put(CONF.UPDATE_BLACKLIST.replace("${bid}", bid), blType);
  },
  deleteBlacklist(bid) {
