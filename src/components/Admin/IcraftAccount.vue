<template>
  <div class="tableBs">
    ...
    <v-flex d-flex xs12 sm12 md12>
      <modal :width="modal_size" :height="modal_size" name="icr_acount" transition="pop-out">
        <v-card tile>
    ...
    <!-- modal edit -->
    <v-flex d-flex xs12 sm12 md12>
      <modal :width="modal_size" :height="modal_size" name="icr_acount_edit" transition="pop-out">
        <v-card tile>
          <v-toolbar card dark color="primary">
            <v-toolbar-title>iCraft 계정 수정</v-toolbar-title>
            <v-spacer></v-spacer>
            <v-toolbar-items>
...
export default {
  ...
  methods: {
    showModal() {
      this.$modal.show("icr_acount");
    },
    showEditModal() {
      this.$modal.show("icr_acount_edit");
    },
    toggleAll() {
